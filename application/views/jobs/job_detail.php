...
#material-detailed td {
  border: 1px solid black;
            ...
            <div class="top-bar">
                <!-- BEGIN: Breadcrumb -->
                <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Urbanfence</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <span class="breadcrumb--active">Jobs Detail</span> </div>
                <!-- END: Breadcrumb -->
                <!-- BEGIN: Account Menu -->
            ...
            <fieldset class="p-2 mb-3 w-full fieldset_bd_color">
              <legend class="legend_spacing">Job #01</legend> 
                <div class="intro-y grid grid-cols-12 p-5 mt-5 gap-2 ">
	                ...
	                <div class="col-span-12 sm:col-span-12 box m-auto w-full lg:w-5/6 p-5 fieldset_bd_color display_info_block" style="position: relative;right: 12px;background-color:#1C3FAA !important;">
	                	<div class="w-full md:w-4/5 lg:w-1/2 border_color p-1 fieldset_bd_color mr-1 sm:mr-2 md:mr-5 mb-2 sm:mb-0" style="background-color: white">
	                  	...
	                  	<div class="w-full md:w-4/5 lg:w-1/2 border_color p-1 fieldset_bd_color" style="background-color: white">
              	...
              	<div class="intro-y grid grid-cols-12 p-5 mt-5 gap-2">
                    ...
                    <legend class="legend_spacing">Materials Settings</legend>
                           ...
                           <label class="cursor-pointer select-none" for="vertical-remember-me" style="width: auto;">Need to order Material</label>
                        </div>
                        <div class="float-right w-1/2 mb-5">
                		 	    <div class="mt-1 mb-2" >
                              <input type="checkbox" class="input border mr-2" id="vertical-remember-me_r1">
                              <label class="cursor-pointer select-none" for="vertical-remember-me_r1" style="width: auto;">Materials in stack</label>
                          </div>
                          <div class="mt-1 mb-2">
                              <input type="checkbox" class="input border mr-2" id="vertical-remember-me_r2">
                              <label class="cursor-pointer select-none" for="vertical-remember-me_r2" style="width: auto;">Materials Collected</label>
                          </div>
                          <div class="mt-1 mb-4">
                              <input type="checkbox" class="input border mr-2" id="vertical-remember-me_r3">
                              <label class="cursor-pointer select-none" for="vertical-remember-me_r3" style="width: auto;">Materials Delivered</label>
                          </div>
                        </div>
                      </fieldset>
              		 </div>
                ...
                <div class="p-5">
                  <a data-target="#material-detailed" data-toggle="modal" class="button  bg-theme-1 text-white">Material Tracking</a>
                </div>
...
<div class="modal" id="material-detailed">
     <div class="modal__content modal__content--lg p-5 text-center" style="width: 75%;">
      ...
      <div class="mt-1 mb-5" >
           ...
           <label style="float:left;" class="cursor-pointer select-none" for="vertical-remember-me">Need to order Material</label>
      </div>
