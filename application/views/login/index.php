    ...
    <div class="container sm:px-10">
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    <img alt="Midone Tailwind HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="<?php echo base_url();?>assets/images/illustration.svg">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                   ...
                   <!--  <div class="intro-x mt-2 text-gray-500 xl:hidden text-center">A few more clicks to sign in to your account. Manage all qoutes in one place</div> -->
                    ...
                    <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                        <button onclick="window.location.href='<?php echo base_url(); ?>Dashboard'" class="button button--lg w-full xl:w-32 text-white bg-theme-1 xl:mr-3">Login</button>
