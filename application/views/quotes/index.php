  ...
  @media screen and (max-width: 767px) {
    button.width_filter{
      width:6rem;
            ...
            <div class="top-bar">
                <!-- BEGIN: Breadcrumb -->
                <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Urbanfence</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Quotes List</a> </div>
                <!-- END: Breadcrumb -->
                <!-- BEGIN: Account Menu -->
