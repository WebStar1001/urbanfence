    ...
    button.width_filter{
      width:6rem;
          ...
          <div class="content">
            ...
            <div class="top-bar">
                <!-- BEGIN: Breadcrumb -->
                <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Urbanfence</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Customers List</a> </div>
                <!-- END: Breadcrumb -->
                <!-- BEGIN: Account Menu -->
            ...
            <!-- BEGIN: Filters -->
              <div class="intro-y grid grid-cols-12 p-5 mt-5 gap-2 box">
                ...
                <div class="col-span-12 sm:col-span-6 md:col-span-4 flex items-end">
                  <div>
                    <button class="button w-24 mr-1  bg-theme-1 text-white">Clear filter</button> <button  class="button w-24 mr-1  bg-theme-6 text-white width_filter">filter</button>
                  </div>
                </div>
              </div> 
            <!-- END: Filters -->
