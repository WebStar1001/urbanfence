    ...
    @media screen and (max-width: 639px) {
        ...
        <div class="content">
            ...
            <div class="top-bar">
                <!-- BEGIN: Breadcrumb -->
                <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Urbanfence</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Add New Opportunity</a> </div>
                <!-- END: Breadcrumb -->
                <!-- BEGIN: Account Menu -->
...
<!-- update mokeup hide session --
   ...
   -->    
                        ...
                        <div class="preview">
                            ...
                            <div class="intro-y flex flex-col sm:flex-row">
                                ...
                                <div class="col-span-8">
                                    <div class="sm:w-full col-span-3 sm:pl-4 sm:pr-4 mt-2 sm:mt-0">
                                ...
                                <select class="input w-full border flex-1">
                                    ...
                                    <div class="sm:w-full col-span-3 sm:m-auto sm:pl-2 sm:pr-2 mt-2 sm:mt-0 sm:text-right">
                                        <label class="w-full w-1/3 text-left sm:pt-3 mr-3 sm:mr-0">Create New Customer</label>
                                        <a href="<?php echo base_url('Opportunity/add_customer');?>"><i style="font-size: 30px;" class="w-full fa fa-user-plus" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-6 md:ml-3" id="add_opppor_left_info">
                        <div class="preview">
                            <div class="intro-y flex flex-col sm:flex-row">
                                ...
                                <input type="text" disabled class="bg-gray-100 cursor-not-allowed input w-full sm:w-1/2 md:w-1/2 border mt-2 flex-1">
                            </div>
                   ...
                   <div class="col-span-12">
                        <div class="preview">
                            <button onclick="window.location.href='<?php echo base_url(); ?>Opportunity/pending_opportunities'" style="float: right;" type="button" class="button bg-theme-1 text-white mt-5 sm:p-2">Create Opportunity</button>
                        </div>
                   </div>
                </div>
              </div>
